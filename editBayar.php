...
$data2 = mysql_query("SELECT SUM(total) FROM bayar WHERE id_transaksi = '$_GET[idtran]'");
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
            ...
            <h3><i class="fa fa-money"></i> Bayar Transaksi <?php echo $isi[0]; ?></h3>
		</div>
		<div class="modal-body">
		<form id="MyForm" method="post" action="updateBayar.php">
            ...
            <label>Piutang / Sisa Bayar : <?php echo "Rp. ".number_format($isi['harga']-$isi2[0],0,",","."); ?></label><br>
            ...
            <hr>
            <button type="submit" class="btn btn-primary btn-lg btn-flat pull-right" id="bayar" style="margin-left: 20px">
            ...
            <div id="hasil_bayar" style="display: none"></div>
            <br>
            </form>
		</div>
	</div>
